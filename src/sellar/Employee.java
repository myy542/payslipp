...
public class Employee {
    ...
    public void addEmployee() {
        ...
        String sql = "INSERT INTO t_employee (id, fname, lname, position, department) VALUES ( ?, ?, ?, ?)";
    ...
    public void viewEmployees() {
        ...
        String query = "SELECT id, fname, lname, position, department FROM t_employee";
        String[] headers = {"ID", "First Name", "Last Name", "Position", "Department"};
        String[] columns = {"id", "fname", "lname", "position", "department"};
    ...
    public void updateEmployee() {
        ...
        String sql = "UPDATE t_employee SET fname = ?, lname = ?, position = ?, department = ? WHERE e_id = ?";
